...
<?php
    ...
    $taxonomy = explode("/", $_SERVER['REQUEST_URI'], 3);
    $term     = str_replace("/", "", $taxonomy[count($taxonomy)-1]);
...
<section class="pdexgroup__taxonomy" id="pdexgroup-taxonomy">
...
<?php while($query->have_posts()): $query->the_post(); ?>
    ...
    <article class="pdexgroup__taxonomy-article">
        ...
        <div class="pdexgroup__taxonomy-article-info">
            ...
            <p class="pdexgroup__taxonomy-article-info-text">
                ...
                <?= substr(get_the_content(), 0, 200) . "..."; ?>
            </p>
        </div>
        <div class="pdexgroup__taxonomy-article-contact">
            <a href="<?= $contact_url . '?text=' . $message; ?>" target="_blank">
                <span>Contact</span>
...
<div class="pdexgroup__sentinel" id="pdexgroup-taxonomy-sentinel"></div>
